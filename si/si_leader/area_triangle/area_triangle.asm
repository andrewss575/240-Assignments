...
; This code is less optimized but the easiest way
...
_start:
	...
	;moving the new value of ax(1593) to ax. We do not need this line because, we still need to divide ax/2
	mov	word[area], ax
	...
	;NOTE: We found the area but as a whole number. A remainder does NOT occur in this instance 
	; so dx is 0 but it's good practice to save it in a variable anyways. If you'd like, you can add one :)
