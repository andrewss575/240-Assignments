...
_start:
	; moves byte to al register
        ...
        ; subtracts num1 from al(num2), which makes al 156 because binary subtraction 
        ; uses 1's compliments, and this resulted in 156
        sub     al, byte[num2]                                  ;al = al - num2 = 9ch
        
        ; sbb subtraction CF, which is 1, from 0 which results to -1 or 1111 1111 of 0xff
